...
class _AccessCodeScreenState extends State<AccessCodeScreen>
  ...
  void initState() {
    ...
    // CORREÇÃO: Garantir que o primeiro campo receba foco após a tela carregar
  ...
  Future<void> _validateCode() async {
    ...
    // Remove o foco antes de validar para fechar o teclado
    ...
    try {
      final snapshot =
          await FirebaseDatabase.instance.ref('Invitation_code').get();

      if (!mounted) return;

      final validCode = snapshot.value?.toString().trim().toUpperCase() ?? '';
      final inputCode = _fullCode.trim().toUpperCase();
  ...
  void _onDigitChanged(int index, String value) {
    ...
    if (value.isNotEmpty) {
      if (index < _codeLength - 1) {
        ...
        // Último dígito - remove o foco e valida
        FocusScope.of(context).unfocus();
        // Pequeno delay para garantir que o valor foi processado
                ...
                children: [
                  ...
                  AnimatedSwitcher(
                    ...
                    child: _hasError
                        ...
                        : const SizedBox(
                            key: ValueKey('no-error'), height: 14),
                  ),
      ...
      child: RawKeyboardListener(
        ...
        child: Center(
          child: TextField(
            ...
            // CORREÇÃO: Adicionar enableInteractiveSelection
            enableInteractiveSelection: false,
            // CORREÇÃO: Adicionar showCursor
            showCursor: true,
            // CORREÇÃO: Forçar abertura do teclado em tablets
            autofocus: index == 0, // Apenas o primeiro campo tem autofocus
            inputFormatters: [
            ...
            // CORREÇÃO: Adicionar onTap para garantir que o teclado abra ao tocar
            onTap: () {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        child: Stack(
          ...
          children: [
            if (widget.isPrimary && widget.enabled)
              AnimatedBuilder(
                animation: _shimmer,
                builder: (_, __) => CustomPaint(
...
class _LockRosaIcon extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final arcRect =
        Rect.fromCenter(center: Offset(cx, cy - 3), width: 18, height: 16);
