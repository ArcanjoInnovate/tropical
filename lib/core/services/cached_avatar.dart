...
//
// NÍVEL 2.2 — Usa CachedNetworkImage em vez de Image.network (cache em disco).
// NÍVEL 2.3 — Usa CloudinaryHelper.avatarUrl para servir avatar otimizado.
//
// Uso simples:
...
class _CachedAvatarState extends State<CachedAvatar> {
  ...
  Widget _buildImage() {
    ...
    if (url != null && url.isNotEmpty) {
      // NÍVEL 2.2 + 2.3 — CachedNetworkImage + Cloudinary avatar optimization
      return CachedNetworkImage(
        imageUrl: CloudinaryHelper.avatarUrl(url, size: widget.size.toInt() * 2),
        fit: BoxFit.cover,
